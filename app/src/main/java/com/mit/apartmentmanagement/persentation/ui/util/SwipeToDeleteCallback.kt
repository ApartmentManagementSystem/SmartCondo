package com.mit.apartmentmanagement.persentation.ui.util
...
abstract class SwipeToDeleteCallback(context: Context) : ItemTouchHelper.SimpleCallback(
    ...
    private val deleteBackground = ContextCompat.getColor(context, R.color.delete_background)
    ...
    override fun onChildDraw(
        ...
        val background = android.graphics.drawable.ColorDrawable(deleteBackground)
